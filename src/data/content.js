...
export const experiences = [
  {
    ...
    summary:
      "Shipped a production conversational AI assistant for an internal enterprise compliance platform as end-to-end feature owner. The assistant runs as an agent on AWS Bedrock AgentCore Runtime, using retrieval-augmented generation and live data-search tools.",
    bullets: [
      "Shipped a production conversational AI assistant for an internal enterprise compliance platform as end-to-end feature owner. The assistant runs as an agent on AWS Bedrock AgentCore Runtime, using retrieval-augmented generation (RAG) and live data-search tools.",
      "Engineered a fail-closed anti-hallucination design with Bedrock Guardrails grounding, a refusal-first system prompt, and prompt-injection hardening. As a result, the assistant cites authoritative sources or declines to answer. It never fabricates.",
  ...
  },
  {
    ...
    summary:
      "Developing battery monitoring, telemetry, and power-awareness systems. These systems connect embedded sensing with real robotics operations.",
    bullets: [
      "Developing battery monitoring, telemetry, and power-awareness systems. These systems connect embedded sensing with real robotics operations.",
    ],
  ...
  },
  {
    ...
    summary:
      "Contributing to engineering work that connects infrastructure thinking with reliability, access, and real-world impact.",
    bullets: [
      "Contributing to engineering work that connects infrastructure thinking with reliability, access, and real-world impact.",
    ],
  ...
  },
  {
    ...
    summary: "Supervised lifeguard staff and daily deck operations. Owned safety enforcement and shift coordination.",
    bullets: ["Supervised lifeguard staff and daily deck operations. Owned safety enforcement and shift coordination."],
    stack: [],
  },
  {
  ...
  },
  {
    ...
    summary: "Supported high-volume campus dining operations. Built consistency and operational discipline.",
    bullets: ["Supported high-volume campus dining operations. Built consistency and operational discipline."],
    stack: [],
  },
  {
    ...
    summary:
      "Led student teams that raised funds and delivered school supplies to rural schools during Sri Lanka's economic crisis.",
    bullets: [
      "Led student teams that raised funds and delivered school supplies to rural schools during Sri Lanka's economic crisis.",
    ],
    stack: [],
...
export const featuredProjects = [
  {
    ...
    role:
      "I owned the feature end-to-end. My work covered the Bedrock AgentCore agent, the RAG grounding and guardrails design, the Java-based live control-search feature, the change-stream sync pipeline, and production incident response.",
    stack: [
      "AWS Bedrock AgentCore",
      "Bedrock Knowledge Bases",
      "Bedrock Guardrails",
    ...
    systemDesign: [
      ...
      "Serverless search data layer, chosen from first-hand p90 latency benchmarking against a hard budget. Rejected a data-warehouse design based on the evidence. Roughly 10–20x cheaper.",
      "Live control-search feature in Java with relevance and fuzzy matching plus nested dependency queries.",
      "Change-stream sync pipeline that keeps the search index continuously fresh, with deploy-time bootstrap and historical backfill.",
    ],
    challenges: [
      "Preventing hallucination in a compliance-sensitive assistant without making it useless. This meant balancing grounding against refusal rate.",
  ...
  },
  {
    ...
    summary:
      "The tool is built around Electricity Maps forecast data for US-MIDW-MISO. It pulls carbon-intensity forecasts, applies deadline-aware ranking, and estimates job energy through manual input or NVIDIA GPU power sampling.",
    role:
      "I built the Python CLI workflow and connected the forecast data. I implemented the emissions-ranking logic and added deadline filtering. I integrated NVIDIA GPU power sampling through nvidia-smi.",
  ...
  },
  {
    ...
    impact:
      "A Python simulation prototype. It explores how data centers can coordinate grid electricity, on-site solar, battery storage, and flexible workloads to study carbon and cost tradeoffs.",
    summary:
      "EcoDispatch models solar, battery, grid, and flexible demand in a scenario-analysis workflow with a Streamlit dashboard. The current version is a transparent prototype, not a production control system. It compares dispatch strategies, stress-test scenarios, and cost-versus-carbon tradeoffs.",
    role:
      "I built the simulation workflow and implemented the battery and solar models. I added dispatch strategy logic and rolling-horizon behavior. I built the Streamlit dashboard. I also connected the project to prototype Arduino and Raspberry Pi monitoring flows.",
    ...
    reflection:
      "The project is strongest as a transparent engineering prototype. It makes tradeoffs visible and testable, without claiming the control logic is ready for deployment. The next honest steps: better battery energy provenance tracking, stronger demand modeling, and a fuller multi-period optimization formulation.",
    metrics: [
  ...
  },
  {
    ...
    summary:
      "The system tracks voltage and current. It supports voltage-based state-of-charge estimation and detects battery swaps. It streams telemetry to a Jetson controller for logging and decision-making.",
    role:
      "I contributed to the battery monitoring flow. My work covered current and voltage telemetry, state-of-charge estimation, battery swap detection logic, and real-time communication to the Jetson controller.",
...
export const awards = [
  {
    ...
    date: "May 2025",
    text: "Issued by Amazon and associated with Maine East High School. The scholarship recognized academic excellence, leadership, and commitment to computer science and STEM. It included $40,000 in college scholarship support and a paid Amazon internship pathway.",
  },
  {
    title: "Park Ridge Rotary Make a Difference Scholarship",
    date: "Apr 2025",
    text: "Issued by the Park Ridge Rotary Club and associated with Maine East High School. The club awarded its top scholarship amount, $1,250, in recognition of empathy, leadership, work ethic, and community impact.",
  },
  {
    title: "Sadie Rose Argus Scholarship",
    date: "Apr 2025",
    text: "Issued by the Des Plaines Community Foundation and associated with Maine East High School. The foundation awarded a $1,500 scholarship recognizing social service, community involvement, and academic achievement in the Des Plaines area.",
  },
  {
    title: "Illinois State Scholar",
    date: "Mar 2025",
    text: "Issued by the Illinois Student Assistance Commission and associated with Maine East High School. The commission recognized Roseth as an Illinois State Scholar for strong academic achievement.",
  },
];
